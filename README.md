...
<script defer src="https://cdn.jsdelivr.net/npm/x_ite-spz-parser@1.1.4/dist/x_ite-spz-parser-123.min.js"></script>

<!-- or as ES module -->
<script type="module" src="https://cdn.jsdelivr.net/npm/x_ite@VERSION/dist/x_ite.min.mjs"></script>
<script type="module" src="https://cdn.jsdelivr.net/npm/x_ite-spz-parser@1.1.4/dist/x_ite-spz-parser-4.min.js"></script>
<!-- or/and for version 1-3 SPZ format -->
